...
| t15| ------ |```UPDATE EMP SET SAL = 5200 WHERE ENAME ='Maaoui';```|On va tenter de modifier le salaire de l'employé 'Maaoui' à 5200 dans la session N°2 or il existe un lock sur la ligne concernant l'employé 'Maaoui' donc la session N°2 va rester en attente d'un ordre COMMIT dans la session N°1.|
