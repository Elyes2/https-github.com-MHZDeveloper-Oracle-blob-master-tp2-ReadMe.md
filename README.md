...
| :----: | :----: |:----:|:----:|
| t0 | ``` SELECT ENAME, SAL FROM EMP WHERE ENAME IN ('Mohamed','Hichem');``` ||On obtient les noms et les salaires des employés 'Mohamed' et 'Hichem'<br>.Mohamed          2000
Hichem           2800|
...
| :----: | :----: |:----:|:----:|
| t0 | ``` SELECT ENAME, SAL FROM EMP WHERE ENAME IN ('Mohamed','');``` |||
